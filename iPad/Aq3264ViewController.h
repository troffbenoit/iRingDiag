...
@interface Aq3264ViewController : UIViewController {
    ...
    IBOutlet UIScrollView *voltageDisplayScrollView;
	//
	...
	IBOutlet UIImageView *ledDC_7;
	IBOutlet UIImageView *ledDC_8;
	...
	IBOutlet UIImageView *ledAC_7;
	IBOutlet UIImageView *ledAC_8;
...
@property(strong, nonatomic)IBOutlet UIImageView *ledDC_7;
@property(strong, nonatomic)IBOutlet UIImageView *ledDC_8;
...
@property(strong, nonatomic)IBOutlet UIImageView *ledAC_7;
@property(strong, nonatomic)IBOutlet UIImageView *ledAC_8;
